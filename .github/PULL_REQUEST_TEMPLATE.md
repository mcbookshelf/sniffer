...
- [ ] I have updated the [changelog](https://github.com/mcbookshelf/sniffer/tree/master/docs/changelog) to reflect my contribution.
- [ ] If this pull request adds or modifies a feature:
  - [ ] I have documented my changes in the `/docs` folder.
  - [ ] I have added integration or unit tests for my changes.
