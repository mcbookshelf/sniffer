...
public class DatapackBreakpointClient implements ClientModInitializer {
	...
	public void onInitializeClient() {
		stepInto = KeyMappingHelper.registerKeyMapping(new KeyMapping(
				"sniffer.step", // The translation key of the keybinding's name
				InputConstants.Type.KEYSYM, // The type of the keybinding, KEYSYM for keyboard, MOUSE for mouse.
				GLFW.GLFW_KEY_F7, // The keycode of the key
				KeyMapping.Category.register(Identifier.parse("sniffer.name")) // The translation key of the keybinding's category.
		));
